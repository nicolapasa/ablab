...
<div class="col-md-4">
<div class="form-group row">
<label class="col-md-4 col-form-label bold">Ordina per fatturato:</label>    
<div class="col-md-8">
...
<input type="hidden" name="subreq" value="andamento_utenzef" />
...
<!-- Form actions -->
							<div class="form-actions">
								<button type="submit" class="btn btn-primary">
								  ...
								  <a href="index.php?req=stat&subreq=andamento_utenzef"  class="btn default">RESET</a>
							</div>
							<!-- // Form actions END -->
	</div>
</form>
