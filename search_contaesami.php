...
<label class="col-md-4 col-form-label bold">Mese corrente:</label>    
<div class="col-md-8">
<select  name="mese"  class="form-control">
 <option value="<?php echo $mese;?>" selected><?php 
 if($mese<10){
 ...
 <?php 
	 ...
	 for ($i=0; $i < 12; $i++) { 
		...
		echo '<option value="'.($i+1).'">'.Utility::getMese($i).'</option>';
...
<input type="hidden" name="subreq" value="conta_esami" />
...
<!-- Form actions -->
							<div class="form-actions">
								<button type="submit" class="btn btn-primary">
								  ...
								  <a href="index.php?req=stat&subreq=conta_esami"  class="btn default">RESET</a>
							</div>
							<!-- // Form actions END -->
	</div>
</form>
