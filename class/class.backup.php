...
class Backup {
	 ...
	 * @param string $lang
	 */
    function __construct($host = DB_HOST, $username = DB_USER, $password = DB_PASS, $database = DB_NAME, $charset = 'utf-8', $lang = 'en') {
	    $this->setLang($lang);
        $this->host = $host;
    ...
    function backup($tablename = null, $dir = null, $size = null) {
        ...
        if ( $tablename ) {
            ...
            //
            $tables = mysqli_query ($this->conn , "SHOW FULL TABLES where Table_type='BASE TABLE'" );
            //
            $p = 1;
            //
