...
if($sconto!=0 and $sconto!=''){
	...
	if($sconto==10) 	$dicitura='(10%  su importi superiori a 300 euro)';
	if($sconto==20) 	$dicitura='(20%  su importi superiori a 900 euro)';
